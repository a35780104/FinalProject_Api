...
func (a Product) Create(db *gorm.DB) (*Product, error) {
...
func (a Product) Update(db *gorm.DB, values interface{}) error {
...
func (a Product) Get(db *gorm.DB) (Product, error) {
	var product Product
	db = db.Where("id = ?", a.ID)
...
func (a Product) Delete(db *gorm.DB) error {
